...
import { DataSource, DataSourceConnectionResponse, Id, PAGINATION_STARTING_PAGE_NUMBER, dataSourceToReadableName } from "@repo/core";
...
export const DocumentsDataSourceSelector = ({
  ...
  useEffect(() => {
    ...
    const newDataSourceRecords = getDataSourceRecords(dataSourceConnectionsResponse.response);
  ...
  return (
    <div>
      <Tooltip tipContent={tooltTipText}>
        <div
          className={tw("items-center p-3 w-48 rounded-lg border border-gray-200 bg-white shadow-md m-2 cursor-pointer hover:bg-gray-50")}
          onClick={() => {
            setShowModal(true);
          }}>
  ...
  return (
    <div>
      <Tooltip tipContent="Upload documents" >
        ...
        >
          <div
            className={tw("items-center p-3 rounded-lg w-48 border border-gray-200 bg-white shadow-md m-2 cursor-pointer hover:bg-gray-50")}
          >
            <div className={tw("flex flex-row items-center")}>
